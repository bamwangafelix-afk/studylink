...
const SHELL=['./','./index.html','./css/styles.css?v=studylink-pwa-36','./js/app-v20.js?v=studylink-pwa-36','./manifest.webmanifest?v=studylink-pwa-36','./icons/studylink-192.png?v=studylink-pwa-36','./icons/studylink-512.png?v=studylink-pwa-36','./icons/studylink-login-full-logo.png?v=studylink-pwa-36'];
