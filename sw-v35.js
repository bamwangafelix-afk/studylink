...
const SHELL=['./','./index.html','./css/styles.css?v=studylink-pwa-35','./js/app-v20.js?v=studylink-pwa-35','./manifest.webmanifest?v=studylink-pwa-35','./icons/studylink-192.png?v=studylink-pwa-35','./icons/studylink-512.png?v=studylink-pwa-35','./icons/studylink-login-full-logo.png?v=studylink-pwa-35'];
