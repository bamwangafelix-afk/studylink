...
const SHELL=['./','./index.html','./css/styles.css?v=studylink-pwa-37','./js/app-v20.js?v=studylink-pwa-37','./manifest.webmanifest?v=studylink-pwa-37','./icons/studylink-192.png?v=studylink-pwa-37','./icons/studylink-512.png?v=studylink-pwa-37','./icons/studylink-login-full-logo.png?v=studylink-pwa-37'];
